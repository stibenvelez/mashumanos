            ...
            <div className="flex min-h-screen bg-gray-50">
                <div className="container flex flex-col items-center justify-center px-2 mx-auto space-y-4">
                    <div className="space-y-2">
                        ...
                        <h3 className="text-6xl font-bold text-center text-gray-600 capitalize lg:text-left">
                            Conoce nuestros servicios
                        </h3>
                        <p className="text-lg font-semibold text-center text-gray-700 lg:text-left ">
