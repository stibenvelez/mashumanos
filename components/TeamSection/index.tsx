...
const TeamSection = () => {
    return (
        <section id="team" className="overflow-hidden bg-gray-50 ">
            <div className="container flex flex-col items-center justify-center min-h-screen p-2 mx-auto ">
                <div className="flex flex-col justify-center">
                    <h2 className="text-lg  text-center font-bold text-blue-500 lg:text-left">
                        Psicologas
                    </h2>
                    <h3 className="mb-4 text-center text-6xl font-bold  text-gray-600 lg:text-left">
                        Nuestro Equipo
                    </h3>
                    <p className="text-center text-gray-500 lg:text-left">
                        Nuestro equipo lo componen 3 comprometidas psicólogas
                    </p>
                    <div className="flex flex-wrap gap-16 justify-center py-8 lg:py-16">
